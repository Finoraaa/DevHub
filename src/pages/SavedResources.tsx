...
export function SavedResources({ user }: SavedResourcesProps) {
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-serif italic font-bold text-[#5A5A40] dark:text-[#8B8B6B]">Saved Resources</h1>
          <p className="text-[#1a1a1a]/60 dark:text-white/40 mt-1">Your personal collection of curated developer tools.</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white dark:bg-[#141414] rounded-[2rem] border border-dashed border-[#5A5A40]/20 dark:border-white/10">
          ...
          <h3 className="text-xl font-serif italic font-bold text-[#5A5A40] dark:text-[#8B8B6B]">No saved resources</h3>
          <p className="text-[#1a1a1a]/40 dark:text-white/20 mt-2">Explore the hub and save resources you find interesting!</p>
          <button
